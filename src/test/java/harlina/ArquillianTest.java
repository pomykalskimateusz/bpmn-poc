...
public class ArquillianTest {
  ...
  private static final String PROCESS_DEFINITION_KEY = "Harlina";
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "harlina.war")
            ...
            .addPackages(false, "Harlina") // not recursive to skip package 'nonarquillian'
            // add process definition
            .addAsResource("gitlab_users.bpmn")
